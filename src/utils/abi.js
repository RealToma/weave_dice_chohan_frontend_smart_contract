export const HUNT_ABI = [
  ...
  {
    inputs: [
      { internalType: "address[]", name: "blacklisted_", type: "address[]" },
    ],
    name: "delBlacklisted",
    outputs: [],
    stateMutability: "nonpayable",
...
export const DICE_ABI = [
  ...
  {
    inputs: [],
    name: "getLast10Result",
    outputs: [
      {
        components: [
          { internalType: "address", name: "user", type: "address" },
          { internalType: "uint8", name: "currentNumber1", type: "uint8" },
          { internalType: "uint8", name: "currentNumber2", type: "uint8" },
          { internalType: "bool", name: "isEven", type: "bool" },
          { internalType: "uint256", name: "amount", type: "uint256" },
          {
            internalType: "enum Dice.BettingStatus",
            name: "status",
            type: "uint8",
          },
        ],
        internalType: "struct Dice.BetInfo[10]",
        name: "result",
        type: "tuple[10]",
      },
    ],
